...
<body>
	...
	<br>
	<form method="post" action="user_DC_index.cc">
		<select name="type">
	...
	<form action="user_del_dc.cc" method="post">
		...
		<c:forEach items="${dc }" var="food" varStatus="vs">
			...
			<td><input type="checkbox" name="dcids" value="${food.dcid }"></td>
		</tr>
		</c:forEach>
	</table>
	<p style="text-align:center"><input type="submit" value="从点餐车删除"></p>
	</form>
</body>
</html>